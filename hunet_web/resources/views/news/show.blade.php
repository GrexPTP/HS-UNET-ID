                ...
                <div class="card-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-4 text-right">
                            <a style="font-size: 1rem" href="{{ route('news.edit', $news->id) }}" class="btn btn-sm btn-primary">UPDATE</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form>
                        <div class="pl-lg-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-username">Creator</label>
